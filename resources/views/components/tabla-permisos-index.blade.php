@props(['permisos'])
{{-- <div class="rounded-xl overflow-hidden flex shadow hover:shadow-2xl bg-white cursor-pointer h-full">    
...
<div class="overflow-x-auto">
    ...
    <div class=" rounded-xl flex items-center justify-center bg-white p-1 font-sans overflow-hidden">
    {{-- <div class=" rounded-3xl overflow-hidden flex shadow hover:shadow-md bg-blue-300 h-full"> --}}
                    ...
                    <div class=" content-around">
                        <table class="min-w-max w-full table-auto ">
                            <thead>
                                <tr class="bg-gray-100 text-gray-600 uppercase text-sm leading-normal">
                                    <th class="py-3 px-6 text-left">ID</th>
                                    <th class="py-3 px-6 text-left">Ruta de Acceso</th>
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    <td class="py-3 px-6 text-left whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <span class="font-medium">{{$permiso->id}}</span>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6 text-left">
                                        <div class="flex items-center">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center gap-4"> 
                                            ...
                                            @can('admin.categorias.show')                                                                                                
                                                <div class="w-5 mr-2 transform hover:scale-110"> 
                                                    <a href="{{route('admin.permisos.show',$permiso)}}">
                                                        <svg class="rounded-full text-white bg-yellow-400 p-2 hover:bg-yellow-600 "  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                                        </svg>                                                     
                                                    </a>                                                                                                          
