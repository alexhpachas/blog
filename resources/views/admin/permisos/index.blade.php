...
@section('content_header')
    ...
    {{-- Boton Tailwind CSS--}}
    <a class=" float-right bg-blue-500 font-semibold text-white hover:bg-blue-700 py-2 px-4 rounded inline-flex" href="{{route('admin.permisos.create')}}">
        <span class="mr-2">Nuevo Permiso</span>
