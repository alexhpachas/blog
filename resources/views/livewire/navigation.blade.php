<nav class="bg-gray-800" x-data="{ open:false }">
      ...
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
          ...
          <button x-on:click="open=true" type="button" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
            ...
            <svg class="block h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="false">
            ...
            <div class="flex space-x-4">     
              ...
              <a href="#" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium">Dashboard</a>
                ...
                @foreach ($categorias as $categoria)                                
                  ...
                  <a href="{{route('posts.categoria',$categoria)}}{{-- {{$categoria->slug}} --}}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">{{$categoria->nombre}}</a>
        ...
        @auth            
          ...
          <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">          
            ...
            <div class="ml-3 relative" x-data="{ open: false }">
              ...
              <!-- OPCIONES DEL USUARIO ( MI PERFIL - CERRAR SESSION)  -->
    ...
    <div x-show="open" x-on:click.away="open=false" class="sm:hidden" id="mobile-menu">
      <div class="px-2 pt-2 pb-3 space-y-1">
        ...
        @foreach ($categorias as $categoria)                  
          <a href="{{route('posts.categoria',$categoria)}}" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">{{$categoria->nombre}}</a>        
        @endforeach
      </div>
    </div>
  </nav>